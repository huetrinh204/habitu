...
$processing = $pdo->query("SELECT COUNT(*) FROM feedbacks WHERE status_fb = 'processing'")->fetchColumn();
    ...
    <div class="bg-cyan-50 rounded-xl p-6 mb-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-5">
            ...
            $cards = [
                ...
                ["Đang xử lý", $processing, "text-orange-500", "ri-time-line"],
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-sm text-gray-500 flex items-center gap-3">
                        ...
                        <span><i class="ri-time-line"></i> <?= date("d/m/Y H:i", strtotime($fb["created_fb"])) ?></span>
                    </p>
                </div>

                <span class="px-3 py-1 rounded-full text-xs
                    <?= $fb["status_fb"] === "unread" ? "bg-blue-100 text-blue-600" : "" ?>
                    <?= $fb["status_fb"] === "processing" ? "bg-yellow-100 text-yellow-600" : "" ?>
                    <?= $fb["status_fb"] === "read" ? "bg-green-100 text-green-600" : "" ?>">
                    <?= ucfirst($fb["status_fb"]) ?>
                </span>
            </div>
